...
import com.android.asif.llc.kotlin.trendymovies.android.utils.MOVIE_VIEW_TYPE
import com.android.asif.llc.kotlin.trendymovies.android.utils.SERIES_VIEW_TYPE
...
class CastAdapter(private val clickListener: CastClickListener) : ListAdapter<DataItem, RecyclerView.ViewHolder>(
    CastDiffUtillCallback()
) {
